package com.example.randomcomplimentapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "RANDOM COMPLIMENT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGetComplimentButton = findViewById(R.id.get_compliment_bt);
        mShowComplimentText = findViewById(R.id.show_compliment_txt);
